...
class NotificationsApi(object):
    ...
    def ack_user_notification(self, id, **kwargs):  # noqa: E501
        ...
        Acknowledge a single notification. Supply the notification `ID` and the notification will be acknowledged  # noqa: E501
    ...
    def bulk_ack_user_notifications(self, body, **kwargs):  # noqa: E501
        """Bulk Ack User Notifications  # noqa: E501

        Bulk acknowledge all your notifications. Supply a list of notifications ids and the notifications will be acknowledged  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.bulk_ack_user_notifications(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param list[BulkUpdateUserNotification] body: (required)
        :return: list[UserNotificationAck]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.bulk_ack_user_notifications_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.bulk_ack_user_notifications_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def bulk_ack_user_notifications_with_http_info(self, body, **kwargs):  # noqa: E501
        """Bulk Ack User Notifications  # noqa: E501

        Bulk acknowledge all your notifications. Supply a list of notifications ids and the notifications will be acknowledged  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.bulk_ack_user_notifications_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method bulk_ack_user_notifications" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `bulk_ack_user_notifications`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/user-notifications/acknowledge', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='list[UserNotificationAck]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_notification_rule(self, id, **kwargs):  # noqa: E501
        ...
        Returns the details of a notification rule. Supply the unique notification rule `ID` and the notification rule will be returned  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_notification_rules(self, **kwargs):  # noqa: E501
        ...
        Returns a list of notification rules by setting the values of the parameters passed. Any parameters not provided will be left unchanged. The notification rules are returned sorted by creation date with the most recently notification rule created appearing first  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_user_notification(self, id, **kwargs):  # noqa: E501
        ...
        Retrieves the detail of a single Notification. Supply the unique notification `ID` and the notification will be returned  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_user_notifications(self, **kwargs):  # noqa: E501
        ...
        Returns a list of your Notification by setting the values of the parameters passed. Any parameters not provided will be left unchanged  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_muted_notification_rule(self, body, id, **kwargs):  # noqa: E501
        """Update Muted Notification Rule  # noqa: E501

        Updates the notification rule to be muted  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_muted_notification_rule(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UpdateMuteNotificationRule body: (required)
        :param int id: (required)
        :return: NotificationRule
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_muted_notification_rule_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_muted_notification_rule_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_muted_notification_rule_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Update Muted Notification Rule  # noqa: E501

        Updates the notification rule to be muted  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_muted_notification_rule_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_muted_notification_rule" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_muted_notification_rule`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_muted_notification_rule`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/notification-rules/{id}/muted', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_notification_rule(self, body, id, **kwargs):  # noqa: E501
        ...
        Updates the notification rule by setting the values of the parameters passed.  Any parameters not provided will be left unchanged  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
