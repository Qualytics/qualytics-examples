...
class OperationsApi(object):
    ...
    def create_operation_result(self, body, **kwargs):  # noqa: E501
        """Create Operation Result  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_operation_result(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CreateOperationResult body: (required)
        :return: ResponseCreateOperationResultApiOperationsResultPost
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_operation_result_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_operation_result_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_operation_result_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create Operation Result  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_operation_result_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_operation_result" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_operation_result`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ResponseCreateOperationResultApiOperationsResultPost',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_operations(self, **kwargs):  # noqa: E501
        ...
        :param int page:
        :param int size:
        :return: PageUnionGetCatalogOperationGetProfileOperationGetHashOperationGetScanOperation_
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_operations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'operation_type', 'finished', 'result', 'data_store', 'page', 'size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PageUnionGetCatalogOperationGetProfileOperationGetHashOperationGetScanOperation_',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_scheduled_operations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['operation_type', 'data_store']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
