...
class QualityChecksApi(object):
    ...
    def get_quality_check_rule_specifications(self, **kwargs):  # noqa: E501
        ...
        :param str name:
        :param bool author:
        :return: list[GetQualityCheckSpecs]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_quality_check_rule_specifications_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[GetQualityCheckSpecs]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_quality_checks_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['data_store', 'container', 'field', 'inferred', 'rule', 'tag', 'sort_created', 'page', 'size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_quality_checks_by_uuid(self, id, **kwargs):  # noqa: E501
        """Get Quality Checks By Uuid  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_quality_checks_by_uuid(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_quality_checks_by_uuid_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_quality_checks_by_uuid_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_quality_checks_by_uuid_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get Quality Checks By Uuid  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_quality_checks_by_uuid_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_quality_checks_by_uuid" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_quality_checks_by_uuid`")  # noqa: E501
