...
class UserTokensApi:
    ...
    def create_token(
        ...
        Create a new authentication token for the currently authenticated user  Authorized Roles: Admin, Manager, Member

        :param create_user_token: (required)
        :type create_user_token: CreateUserToken
    ...
    def _create_token_serialize(
        ...
        if create_user_token is not None:
            _body_params = create_user_token
    ...
    def delete_token(
        ...
        Deletes a user token. Supply the team `ID` and the user token will be deleted  Authorized Roles: Admin, Manager, Member
    ...
    def _delete_token_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/user-tokens/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_tokens(
        ...
        Get the current user tokens  Authorized Roles: Admin, Manager, Member
    ...
    def update_token(
        ...
        Updates a specific authentication token  Authorized Roles: Admin, Manager, Member

        :param id: (required)
        :type id: int
        :param update_user_token: (required)
        :type update_user_token: UpdateUserToken
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _update_token_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_user_token is not None:
            _body_params = update_user_token
