...
class BulkDeleteAnomaly(BaseModel):
    """
    BulkDeleteAnomaly
    """ # noqa: E501
    status: Optional[ArchivedAnomalyStatusType] = None
    id: Id1
    archive: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["status", "id", "archive"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BulkDeleteAnomaly from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BulkDeleteAnomaly from a dict"""
        if obj is None:
            return None
