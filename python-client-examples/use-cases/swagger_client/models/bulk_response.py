...
class BulkResponse(BaseModel):
    """
    Bulk response as defined in :rfc:`RFC7644 §3.7 <7644#section-3.7>`.  .. todo::      The models for Bulk operations are defined, but their behavior is not implemented nor tested yet.
    """ # noqa: E501
