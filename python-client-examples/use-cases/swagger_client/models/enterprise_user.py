...
from swagger_client.models.manager import Manager
...
class EnterpriseUser(BaseModel):
    ...
    employeenumber: Optional[StrictStr] = None
    costcenter: Optional[StrictStr] = None
    organization: Optional[StrictStr] = None
    division: Optional[StrictStr] = None
    department: Optional[StrictStr] = None
    manager: Optional[Manager] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["schemas", "employeenumber", "costcenter", "organization", "division", "department", "manager"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnterpriseUser from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if employeenumber (nullable) is None
        # and model_fields_set contains the field
        if self.employeenumber is None and "employeenumber" in self.model_fields_set:
            _dict['employeenumber'] = None

        # set to None if costcenter (nullable) is None
        # and model_fields_set contains the field
        if self.costcenter is None and "costcenter" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnterpriseUser from a dict"""
        if obj is None:
            return None
