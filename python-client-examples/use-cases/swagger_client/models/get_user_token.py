...
class GetUserToken(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created", "id", "name", "active", "expiration", "last_used", "user", "bearer_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetUserToken from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetUserToken from a dict"""
        if obj is None:
            return None
